...
fun StoreScreen(navController: NavController, viewModel: ViewModel, userEmail: String) {
    val storeItems = listOf(
        ...
        StoreItem(R.drawable.s5, "柵欄2", 20, R.drawable.fence2),
        StoreItem(R.drawable.s6, "柵欄3", 30, R.drawable.fence3),
        StoreItem(R.drawable.s7, "柵欄4", 10, R.drawable.fence4),
        StoreItem(R.drawable.s8, "太陽", 20, R.drawable.sun),
        StoreItem(R.drawable.s9, "拖拉機", 30, R.drawable.tractor),
        StoreItem(R.drawable.s10, "風車", 10, R.drawable.windmill),
        StoreItem(R.drawable.s11, "帽子", 20, R.drawable.hat),
        ...
        StoreItem(R.drawable.s15, "小苒", 10, R.drawable.girl1),
        StoreItem(R.drawable.s16, "小薇", 20, R.drawable.girl2),
        StoreItem(R.drawable.s17, "小浩", 30, R.drawable.boy1),
        StoreItem(R.drawable.s2, "農夫", 20, R.drawable.boy2),
        ...
        StoreItem(R.drawable.s21, "黃雛菊", 30, R.drawable.yellowdaisy),
        StoreItem(R.drawable.s22, "台灣火刺木", 30, R.drawable.tree9),
        StoreItem(R.drawable.s23, "白雛菊", 30, R.drawable.twoflower),
        StoreItem(R.drawable.s24, "香雪蘭", 30, R.drawable.tulip),
        StoreItem(R.drawable.s25, "向日葵", 30, R.drawable.sunflower),
        StoreItem(R.drawable.s26, "鬱金香", 30, R.drawable.flower2),
        StoreItem(R.drawable.s27, "法國菊", 30, R.drawable.oneflower),
        StoreItem(R.drawable.s28, "松樹牛肝菌", 30, R.drawable.mushroom2),
        StoreItem(R.drawable.s29, "山紅菇", 30, R.drawable.mushroom1),
        StoreItem(R.drawable.s30, "鈴蘭", 30, R.drawable.lilyofthevalley),
        StoreItem(R.drawable.s31, "薰衣草", 30, R.drawable.lavender),
        StoreItem(R.drawable.s32, "風信子", 30, R.drawable.hyacinth),
        StoreItem(R.drawable.s33, "玉米", 30, R.drawable.corn),
        StoreItem(R.drawable.s34, "樹苗", 30, R.drawable.bud),
        StoreItem(R.drawable.s35, "種子", 30, R.drawable.seed35),
        StoreItem(R.drawable.s36, "粉色蘭花", 30, R.drawable.flower1),
        StoreItem(R.drawable.s37, "台灣牛樟", 30, R.drawable.tree3),
        StoreItem(R.drawable.s38, "花圃", 30, R.drawable.flower38),
        ...
        StoreItem(R.drawable.s41, "台灣欒樹", 30, R.drawable.tree10),
        StoreItem(R.drawable.s42, "蘋果樹", 30, R.drawable.tree11),
        StoreItem(R.drawable.s43, "綠樹", 30, R.drawable.tree6),
        StoreItem(R.drawable.s44, "松樹", 30, R.drawable.tree5),
        StoreItem(R.drawable.s45, "玫瑰叢", 30, R.drawable.rosebush),
        StoreItem(R.drawable.s46, "櫻花樹", 30, R.drawable.tree7),
        StoreItem(R.drawable.s47, "銀杏樹", 30, R.drawable.tree8),
